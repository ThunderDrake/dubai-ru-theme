...
class Admin_Side {
	...
	public function add_btn_download_csv() {
		if ( have_posts() && $this->is_page_admin_table() ) {
	...
	public function add_table_filter_forms( $query ) {
		...
		if ( filter_input( INPUT_GET, 'download-csv' ) ) {
	...
	public function table_styles() {
        ...
        word-break: break-all !important;
			...
			.post-type-<?= $this->post_type ?> .row-actions,
			.post-type-<?= $this->post_type ?> .page-title-action,
			.post-type-<?= $this->post_type ?> .subsubsub {
				display: none;
			}
