  ...
  <div class="map-section__container content-container">
    ...
    <div class="map-section__content">
      <div class="map-section__left">
        <h2 class="map-section__title" data-aos="fade-up">Наши клиенты хвалят нас за <span>быструю коммуникацию и сервис</span></h2>
        <div class="map-section__text" data-aos="fade-up" data-aos-delay="600">Кроме того, <span>наше расположение в Дубае</span> позволяет нам глубоко понимать все тонкости процесса открытия бизнеса в ОАЭ</div>
        <div class="map-section__list">
          <div class="map-section__item">
            ...
            <div class="map-section__item-text"><span>Лицензия </span> на оказание <b>бухгалтерских услуг</b></div>
          </div>
          <div class="map-section__item">
