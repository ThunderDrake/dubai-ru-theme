    ...
    <div class="footer__form">
      ...
      <form class="footer__form-form" action="" data-form="footer-form">
        ...
        <input class="footer__form-input input-reset footer__form-input--tel" name="phone" data-phone-country
          type="tel">
        <button class="btn-reset footer__form-button btn--main">Далее</button>
        <label class="custom-checkbox footer__form-checkbox">
          <input type="checkbox" class="custom-checkbox__field">
          <span class="custom-checkbox__content">Нажимая на кнопку вы соглашаетесь с условиями <a href="<?= get_privacy_policy_url() ?>"
              target="_blank">политики конфиденциальности данных</a></span>
        </label>
      </form>
    </div>
  </div>
